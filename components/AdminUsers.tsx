...
export const AdminUsers: React.FC<AdminUsersProps> = ({ 
  users, onUnban, onResetDevice, onUpdateBalance, onManageUser
}) => {
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          {filteredUsers.length === 0 ? (
            <div className="bg-[#0b141a]/80 backdrop-blur-md border border-dashed border-white/10 rounded-3xl p-12 text-center space-y-4">
              <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mx-auto">
                <Users className="w-8 h-8 text-slate-700" />
              </div>
              <div className="space-y-1">
                <p className="text-sm font-black text-white uppercase tracking-widest">No Users Found</p>
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-tighter">Try searching for a different ID or username</p>
              </div>
            </div>
          ) : (
            filteredUsers.map(u => {
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <button 
                        ...
                        className="mt-1 px-3 py-1 bg-neon-blue/10 border border-neon-blue/20 rounded-lg text-[8px] font-black text-neon-blue uppercase tracking-widest hover:bg-neon-blue/20 transition-all"
                      >
                        Manage
                      </button>
